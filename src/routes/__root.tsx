...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Manojkumar — Software Engineer" },
      {
        name: "description",
        content:
          "Portfolio of Manojkumar — Software Engineer building reliable web and mobile applications with Java, Flutter and Vue.js.",
      },
      { property: "og:title", content: "Manojkumar — Software Engineer" },
      {
        property: "og:description",
        content: "Software Engineer building reliable web and mobile applications.",
      },
